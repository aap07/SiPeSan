            ...
            <!-- <div class="col-md-8"> -->
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body box-profile">
                        ...
                        <input type="hidden" class="csrf_tbl_menu" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <table id="tbl-menu" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Menu</th>
...
<script src="<?= base_url('assets/js/backend/administrator/menu_management.js'); ?>"></script>
