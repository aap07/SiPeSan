...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- <div class="col-md-8"> -->
            <form id="fm-ratio-sub" class="form-horizontal" method="post">
                <input type="hidden" class="csrf_ratio_sub" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                <a href="<?= base_url("recruitment/subcriteria/$slug->slug"); ?>" class="btn btn-outline-info btn-sm mb-2"><i class=" fas fa-arrow-alt-circle-left fa-sm mr-2"></i>Kembali ke Subriteria</a>
                                ...
                                <?php
                                    ...
                                    {		
                                        ...
                                        for($i=1;$i<=$jumlah;$i++)
                                        {
                                            $keys = array_keys($arr);
                                            $xxx=$keys[($i-1)];
                                            $newname=$k2."[".$slug->id_kriteria."][".$xxx."]";
                                            $noSub+=1;
                                            if($noSub==$noUtama)
                                            {
                                                ...
                                                if($noUtama > $noSub)
                                                {
                                                    ...
                                                    $nilai=ambil_nilai_subkriteria($k2,$xxx);
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach($arr as $k2=>$v2)
                                    {
                                        ...
                                        echo '<td><input type="text" name="prioritas['.$k2.']['.$slug->id_kriteria.']" class="form-control" id="pri-b'.$noUtama2.'" value="0" readonly=""/></td>';
                                        echo '</tr>';
                                    }
                                ?>
                            </tbody>
...
<script src="<?= base_url('assets/js/backend/recruitment/subratio_management.js'); ?>"></script>
