!(function ($) {
    ...
    $(document).on("submit","#fm-ratio-sub",function(e){
        e.preventDefault();
        $.ajax({
            url: base_url + "recruitment/saveSubratio",
            ...
            error:function(){
                ...
                $("#fm-ratio-sub select").removeAttr("disabled");
                $("#fm-ratio-sub button").removeAttr("disabled");
            },
            beforeSend:function(){
                $("#fm-ratio-sub select").attr('disabled','disabled');
                $("#fm-ratio-sub button").attr('disabled','disabled');
                Toast.fire({
                    icon: "info",
